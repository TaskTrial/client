...
import "../Styles/ProjectPriorityUpdater.css";
const ProjectPriorityUpdater = ({ projectId }) => {
  ...
  const handlePriorityChange = async (e, retried = false) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:3000/api/organization/${orgId}/team/${teamId}/project/${projectId}/priority`,
        {
          method: "PATCH",
          headers: {
...
export default ProjectPriorityUpdater;
